...
function ($scope, $stateParams, $http, $ionicPopup) {
    ...
    $scope.data={};
        ...
        $scope.submit = function () {
            var link = 'https://musical-events.herokuapp.com/login';
...
function ($scope, $http, $stateParams, $ionicPopup) {
    ...
    $scope.logout = function() {
        var linkout = 'https://musical-events.herokuapp.com/logout'
        var myPopup = $ionicPopup.show({
...
function ($scope, $http, $stateParams, $ionicPopup, orgCompany) {
    ...
    $scope.data={};
            ...
            $scope.submit = function () {
                var link = 'https://musical-events.herokuapp.com/loginorg';
                this.email = $scope.data.email;
                this.password = $scope.data.password;
                var organizzatore = ""
...
function ($scope, $http, $stateParams, $ionicPopup, orgCompany) {
    ...
    $scope.remove = function(array, index) {
        ...
        var link = 'https://musical-events.herokuapp.com/events/destroy/' + cod;
                ...
                if(dataAnno === year){
                    if(dataMese < month){
                        ...
                        if(dataGiorno < day){
                                var myPopup1 = $ionicPopup.show({
                                     title: 'ERROR',
                                     subTitle: 'La data inserita e precedente a quella attuale',
                                     buttons: [{text: 'OK', type: 'button-positive'}]
                                });
                                return false
                            }
